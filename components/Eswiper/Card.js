  ...
  return (
    ...
    <div className="mb-12 lg:mb-0">
      ...
      <div className="mb-12 lg:mb-0">
        ...
        <a href="/lesson">
          <p className="text-[14px] mt-2 mb-2 text-blue-500 hover:text-teal-500 uppercase text-center max-w-[80%] mx-auto min-h-[50px] max-h-[68px] overflow-hidden items-center">
           {courseName}
          </p>
        </a>
